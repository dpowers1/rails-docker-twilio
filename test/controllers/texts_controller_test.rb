...
class TextsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post texts_url, params: { text: { inbound: @text.inbound, outbound: @text.outbound, user_id: @text.user_id } }
    end
  ...
  test "should update text" do
    patch text_url(@text), params: { text: { inbound: @text.inbound, outbound: @text.outbound, user_id: @text.user_id } }
